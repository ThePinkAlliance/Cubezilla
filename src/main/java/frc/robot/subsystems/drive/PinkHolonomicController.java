...
public class PinkHolonomicController implements PathFollowingController {
    ...
    public ChassisSpeeds calculateRobotRelativeSpeeds(
        ...
        SmartDashboard.putNumber("dt_x", currentPose.getX());
        SmartDashboard.putNumber("dt_x_setpoint", targetState.getTargetHolonomicPose().getX());

        SmartDashboard.putNumber("dt_y", currentPose.getY());
        SmartDashboard.putNumber("dt_y_setpoint", targetState.getTargetHolonomicPose().getY());

        SmartDashboard.putNumber("dt_theta", currentPose.getRotation().getRadians());
        SmartDashboard.putNumber("dt_theta_setpoint", targetState.heading.getRadians());

        double targetRotationVel = rotationController.calculate(
    ...
    public static void setRotationTargetOverride(
        ...
        PinkHolonomicController.rotationTargetOverride = rotationTargetOverride;
    }
}
